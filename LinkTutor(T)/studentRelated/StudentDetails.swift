...
struct StudentData: Identifiable, Codable, Equatable {
    var id: String
...
class StudentViewModel: ObservableObject {
    @Published var studentDetails = [StudentData]()
        ...
        do {
            ...
            DispatchQueue.main.async {
                ...
                for document in snapshot.documents {
                    ...
                    let userDetail = StudentData(id: id,
        ...
        do {
            ...
            if document.exists {
                if let data = document.data() {
                    ...
                    DispatchQueue.main.async {
                        self.studentDetails = [userDetail]
                    }
                }
            } else {
...
struct StudentDetails: View {
    ...
    var body: some View {
        NavigationView {
            ScrollView {
                ForEach(studentViewModel.studentDetails) { studentDetail in
